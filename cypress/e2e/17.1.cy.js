...
const loginPageElements = require("../fixtures/loginPageElements.json")
...
describe ("santa login -17.1", () => { 
    ...
    it("user cannot login with old password-UI", () => {
        ...
        // cy.get(":nth-child(3)> .frm").type ("oxana.s.sidorova+test@gmail.com");
        ...
        cy.contains("Вход и регистрация").click({force: true})
        // LoginPage.login("oxana.s.sidorova+test@gmail.com", oldPassword)
        cy.get (loginPageElements.loginField).type("oxana.s.sidorova+test@gmail.com");
